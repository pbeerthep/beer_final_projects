...
class OldStudentContent extends Component
{
    ...
    $districts = [],
    $villages = [];
    public $education_year_id, $subject_id, $work_place_id, $image,$newimage,$education_system_id;
    ...
    $this->validate([
        ...
        'phone.required' => 'ປ້ອນເບີໂທ!',
        'phone.min' => 'ເບີໂທຕ້ອງ 8 ໂຕຂຶ້ນໄປ!',
        'phone.unique' => 'ເບີໂທນີ້ມີແລ້ວ!',
        'password.required' => 'ປ້ອນລະຫັດຜ່ານ!',
        'password.min' => 'ລະຫັດຢ່າງໜ້ອຍ 6 ໂຕ!',
        'confirm_password.required' => 'ຢືນຢັນລະຫັດຜ່ານ!',
        'confirm_password.same' => 'ລະຫັດບໍ່ກົງກັນ!',
        // 'roles_id.required' => 'ເລືອກສະຖານະ!',
        'code.required' => 'ປ້ອນລະຫັດ!',
    ]);
    ...
    //     $this->dispatchBrowserEvent('swal', [
    //         'title' => 'ມີຂໍ້ຜິດພາດ!',
    //         'text' => $ex->getMessage(), // จะโชว์ error ถ้าจำเป็น
    //         'icon' => 'error',
    //     ]);
    // }
}
