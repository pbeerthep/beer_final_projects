                        ...
                        <div class="container" >
                            <div class="row justify-content-start">
                                <div class="col-10 col-lg-8">
                                    <h3 class="display-3 animated slideInDown mb-4" style="font-family:'Noto Sans Lao'; color: #193b7c;" >{{ $item->header }}</h3>
                                    <h4 class="display-5 animated slideInDown mb-4" style="font-family:'Noto Sans Lao'; color: #193b7c;" >{{ $item->body }}</h4>
                    ...
                    <div class="col-md-6 col-lg-3 wow fadeInUp" data-wow-delay="0.3s">
                        <div class="service-item p-4">
                            <div class="overflow-hidden mb-4">
                                @if(!empty($item->image))
                                <img style="width: 100%; height:300px" class="img-fluid" src="{{ asset($item->image) }}"
                                alt="">
                                @else
